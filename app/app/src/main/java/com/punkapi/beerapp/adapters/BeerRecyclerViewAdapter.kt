...
class BeerRecyclerViewAdapter(private val context:Context, private var list:ArrayList<BeerModel>, private val itemClick:BeerListItemClick) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.tagTextView.text = list[position].abv.toString()
